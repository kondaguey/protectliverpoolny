  ...
  [
    {
      ...
      body: "<h3 class='text-base font-bold text-white mt-0 mb-1'>Forty-Nine Days Late. Two Days After the Appeal Clock Expired. Ten Days After They Had It Ready.</h3>On <strong>May 8, 2026</strong>, after a 49-calendar-day stall, NYSTA Records Access Officer Jill B. Warner produced <strong>93 records</strong> in response to FOIL Request <span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>#R000082-032026</span> &mdash; just <strong>two business days after our constructive-denial appeal clock expired</strong>. The full set is now hosted at <a href='/foil/' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>the FOIL documents</a> and catalogued at <a href='/the-facts/foil-evidence' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>the FOIL evidence catalog</a>. Here is what the documents prove.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>1. There Is No Alternative Site Analysis. NYSTA Admitted It in Writing.</h3>Item 7 of the original FOIL request asked for the engineering or planning analysis showing why a 184-foot commercial tower had to be built on top of a residential neighborhood, 1.25 miles from a bald eagle roost, ~100 feet from an active highway off-ramp. The response, verbatim from RAO Warner&rsquo;s May 8 letter:<br/><blockquote style='border-left: 3px solid #ef4444; padding-left: 12px; margin: 12px 0; font-style: italic'>&ldquo;No records responsive to Item 7 were located.&rdquo;<br/><span style='font-style: normal; font-size: 11px; opacity: 0.7'>&mdash; Jill B. Warner, Records Access Officer, NYS Thruway Authority, May 8, 2026</span></blockquote><span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>No engineering, no planning, no alternatives study was ever conducted.</span> A bedrock siting requirement was skipped, and NYSTA has now confirmed it on agency letterhead.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>2. NYSTA Wrote Into Its Own Permit That It Can Yank This Tower Tomorrow.</h3>Section II.A of PTI Occupancy Permit T3U250002, in NYSTA&rsquo;s own words:<br/><blockquote style='border-left: 3px solid #ef4444; padding-left: 12px; margin: 12px 0; font-style: italic'>&ldquo;There is no term. This Occupancy Permit is revocable, unilaterally, upon demand by the Authority...&rdquo;<br/><span style='font-style: normal; font-size: 11px; opacity: 0.7'>&mdash; Section II.A, PTI Occupancy Permit T3U250002, issued June 23, 2025</span></blockquote>Every &ldquo;we&rsquo;re locked in&rdquo; excuse falls here. NYSTA can terminate PTI&rsquo;s right to occupy this site <strong>at any time, for any reason, with no penalty</strong>. This is a political choice, not a legal constraint.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>3. The Surrounding Parcel Is Zoned R-O (Residence-Office).</h3>AT&amp;T&rsquo;s own construction drawings (Rev 2, November 7, 2025), Sheet T01, lists the <strong>Zoning District as R-O (Residence-Office)</strong>. R-O is a <strong>residential</strong> zoning class. Under any local approval process, a 184-foot commercial telecommunications structure does not belong on R-O zoning. The state-land preemption was used precisely to bypass it. <a href='/foil/att-construction-drawings-rev2-20251107.pdf' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>Read AT&amp;T&rsquo;s drawings</a>.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>4. AT&amp;T&rsquo;s Internal Site Name Is &ldquo;Liverpool BOCES.&rdquo;</h3>The construction drawings and mount analysis filenames carry AT&amp;T&rsquo;s site identifier: <strong>&ldquo;Liverpool BOCES.&rdquo;</strong> AT&amp;T uses internal site names tied to nearby landmarks. BOCES (Board of Cooperative Educational Services) operates the OCM BOCES program in the Liverpool/Salina area. <strong>School proximity to verify and surface.</strong> If a BOCES facility is within typical RF exposure radius, the children-near-RF angle was not on this campaign&rsquo;s radar. (Source: AT&amp;T FA #15412877, AT&amp;T PTN #2151A0WTHG.)<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>5. The Annual Fee Is Redacted Under a Privacy Law That Doesn&rsquo;t Apply to Corporations.</h3>The Annual Fee paid by Phoenix Tower International &mdash; the rent for occupying public state land &mdash; is <span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>fully blacked out</span>. NYSTA cited New York Public Officers Law &sect;87(2)(b) (&ldquo;personal privacy&rdquo;). The Permittee is <strong>PTI US Towers I, LLC</strong>, a Delaware/Florida limited liability company. Under settled New York case law (<em>Matter of Federation of N.Y. State Rifle &amp; Pistol Clubs v. NYPD</em>, 73 N.Y.2d 92), the personal-privacy exemption protects natural persons, not corporations. The redaction is legally indefensible &mdash; and it is the central financial number of this entire project.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>6. A 30 kW Diesel Generator and 145 Gallons of Fuel.</h3>Buried in <strong>NYSTA Building Permit SYR-2025-003</strong> (issued December 2, 2025 by Joshua Stagnitti, expires December 1, 2028) and confirmed on AT&amp;T&rsquo;s construction drawings: <span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>a 30 kilowatt diesel generator with a 145-gallon belly tank</span>, mounted on a steel platform at grade inside a 50&rsquo;&times;50&rsquo; fenced compound, ~100 feet from the active I-90 off-ramp. No Spill Prevention Control and Countermeasure (SPCC) plan was produced. No air-quality compliance documentation was produced. No public meeting ever mentioned this. <a href='/foil/nysta-building-permit-syr-2025-003-20251202.pdf' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>Read the permit</a>.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>7. Sabre Industries (Texas) Designed the Tower &mdash; Here Are Their Numbers.</h3>The tower designer is <strong>Sabre Industries, Inc.</strong> of Alvarado, Texas, with engineer of record <strong>Robert Beacom</strong> (digital signature July 15, 2025; license expires July 31, 2026). The 36-page sealed structural design report (Job 25-3277-JDS-R1, Rev B) discloses every design parameter:<br/><ul style='margin: 8px 0 8px 16px; list-style: disc'><li style='margin-bottom: 4px'><strong>Standard:</strong> ANSI/TIA-222-H (NY Building Code Chapter 35 references the <em>older</em> TIA-222-G-2005 &mdash; standards mismatch, never reconciled)</li><li style='margin-bottom: 4px'><strong>Design wind speed:</strong> 109 mph (no ice) / 40 mph (with ice)</li><li style='margin-bottom: 4px'><strong>Design ice thickness:</strong> 1.50 inches</li><li style='margin-bottom: 4px'><strong>Risk Category:</strong> II &mdash; the <em>lowest</em> meaningful category, used for structures whose failure would not be expected to cause loss of life. Risk Category III arguably applies given the active I-90 ramp ~100 ft from the base, R-O residential zoning, and 145 gallons of diesel storage. Risk Category II reduces required design loads.</li><li style='margin-bottom: 4px'><strong>Site Class:</strong> D (DEFAULT) &mdash; <em>not field-verified</em>.</li><li style='margin-bottom: 4px'><strong>Base reactions at design wind:</strong> Axial 69.92 kips, Shear 48.07 kips, <strong>Moment 6,352.75 ft-kips</strong>, Deflection 9.54 ft, Sway 4.99&deg;.</li><li style='margin-bottom: 4px'><strong>Foundation:</strong> two options designed, type undecided in this report &mdash; matches the foundation-mismatch concern in NYSTA&rsquo;s own engineering review.</li></ul><a href='/foil/sabre-structural-design-report-rev-b-20250715.pdf' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>Read the Sabre report</a>.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>8. NYSTA&rsquo;s Own Engineer Caught the Project With Missing Paperwork &mdash; for Eight Months.</h3>NYSTA Code Compliance Specialist <strong>Joshua Stagnitti</strong> documented in writing across five review cycles:<br/><ul style='margin: 8px 0 8px 16px; list-style: disc'><li style='margin-bottom: 4px'><strong>6/2/2025:</strong> &ldquo;Structural Analysis Reports have not been submitted. Hazard Reports have not been submitted. Engineered lift plans have not been submitted.&rdquo;</li><li style='margin-bottom: 4px'><strong>8/27/2025:</strong> AT&amp;T review &mdash; &ldquo;Construction Permit Application not submitted. Geotechnical Report not submitted. ASCE Hazard Reports not submitted. Full environmental assessment form not submitted.&rdquo;</li><li style='margin-bottom: 4px'><strong>10/3/2025:</strong> Verizon&rsquo;s footer was submitted at <span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>3&rsquo;-6&rdquo;</span>. NY Code minimum is 4&rsquo;. Six inches below code on first round.</li><li style='margin-bottom: 4px'><strong>11/6/2025:</strong> AT&amp;T Round 2 &mdash; foundation-type mismatch between the TEP Structural Analysis (drilled pier) and the approved construction plans (pad/pier). Closed without a reconciliation memo.</li><li style='margin-bottom: 4px'><strong>11/6/2025:</strong> The TIA-222-H vs. NY-Code 222-G-2005 standards mismatch closed only as &ldquo;DRAWINGS UPDATED.&rdquo; Never reconciled in the public record.</li></ul><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>9. The Crane That Built It Was Filed Separately with the FAA.</h3>FAA Aeronautical Study <strong>2025-AEA-11322-OE</strong> (issued September 22, 2025) documents the construction crane: operator <strong>Clark Rigging &amp; Rental</strong>, contact Mike Dombroski, 945 Spencer Street, Syracuse NY 13204. Crane height during construction: <strong>220 ft AGL / 655 ft AMSL</strong> &mdash; taller than the finished tower. <a href='/foil/faa-7460-crane-2025-aea-11322-oe.pdf' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>Read the FAA crane filing</a>.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>10. Salina Was Notified &mdash; But to the Wrong Supervisor.</h3>The SEQRA determination cover letter and certified-mail green card (USPS <strong>7019 1640 0000 0800 4105</strong>) is in the production. It was addressed to <strong>Nicholas Paro, Town Supervisor</strong>, 201 School Road, Liverpool NY 13088 &mdash; the predecessor to current Supervisor Raul Huerta. Mr. Paro signed for it. The response contains <span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>no record of any reply from the Town</span> under the prior administration. See the separate correction entry below for the formal framing change. Supervisor Huerta inherited this &mdash; he remains an ally.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>11. NYSTA Was Its Own SEQRA Lead Agency.</h3>From the FEAF Part 3: NYSTA classified the action as Type I, designated itself Lead Agency, then issued itself a Negative Declaration. Self-review on public land. The bald eagle dismissal cited the &ldquo;USFWS Northeast Determination Key&rdquo; &mdash; a self-serve web tool, not a formal Section 7 consultation, and not a USFWS letter. <a href='/foil/usny2029-nysta-seqra-r3-final.pdf' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>Read the SEQRA file</a>.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>12. They Had the Documents Ready &mdash; and Kept Them Anyway.</h3>The PDF metadata of the redacted PTI Occupancy Permit (both the &ldquo;Cell Tower&rdquo; and &ldquo;Occupancy Permit&rdquo; copies) carries Adobe Acrobat redaction-completion timestamps of <strong>April 28, 2026</strong>:<br/><ul style='margin: 8px 0 8px 16px; list-style: disc'><li style='margin-bottom: 4px'><strong>10:46:33 EDT</strong> &mdash; redactions saved on file 1 (Occupancy Permit copy)</li><li style='margin-bottom: 4px'><strong>10:50:43 EDT</strong> &mdash; redactions saved on file 2 (Cell Tower copy)</li><li style='margin-bottom: 4px'>XMP toolkit signature <code>x:xmptk=&quot;Adobe XMP Core 9.1-c001 79.675d0f7&quot;</code> identifies the redaction tool as Adobe Acrobat</li><li style='margin-bottom: 4px'>Triple-verified across three independent extractions (<code>exiftool</code>, <code>pdfinfo</code>, raw XMP byte stream); UTC and EDT timestamps converge to the same wall-clock moment</li></ul>That is <strong>six days after the deadline NYSTA &ldquo;blew&rdquo; on April 22</strong>, and the consecutive four-minute timing across two related permit PDFs indicates a single-sitting redaction workflow &mdash; one operator, one Adobe Acrobat session, two saves, both files done. NYSTA then withheld the finalized records for <strong>ten additional days</strong>, releasing them on May 8 &mdash; two business days after our appeal clock under POL &sect;89(4)(a) had run.<br/><br/>Under POL &sect;89(4)(c), a court awarding attorney&rsquo;s fees in a substantially-prevailing FOIL case must find the agency had no reasonable basis for the period of denial. A redaction-saved-on-April-28 / released-on-May-8 timeline is exactly what that standard contemplates. The contemporaneous metadata trace is preserved separately for evidentiary use.<br/><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>What Happens Next</h3><ul style='margin: 8px 0 8px 16px; list-style: disc'><li style='margin-bottom: 6px'><strong>Within 30 days (deadline ~June 7, 2026):</strong> Filing an administrative redaction appeal with the NYSTA Records Appeals Officer demanding the Annual Fee, the fee check amount, and the carrier sub-tenant rent terms. POL &sect;89(4)(c) fee-shifting now supported by the April 28 finalize-and-withhold timestamp.</li><li style='margin-bottom: 6px'><strong>Filing a follow-up FOIL</strong> targeting Verizon RFDS Project ID 17326150, T-Mobile RFDS, the SPCC plan for the diesel generator, and the lift plan as approved by NYSTA Traffic Control.</li><li style='margin-bottom: 6px'><strong>Verifying proximity to OCM BOCES Liverpool facilities</strong> &mdash; AT&amp;T&rsquo;s &ldquo;Liverpool BOCES&rdquo; site name suggests school proximity worth confirming.</li><li style='margin-bottom: 6px'><strong>Calculating the ice-shedding throw envelope</strong> using Sabre&rsquo;s 1.5&rdquo; design ice + 109 mph design wind + 184 ft tower height against the ~100 ft distance to the active off-ramp.</li><li style='margin-bottom: 6px'><strong>Sending the redaction analysis</strong> to the NYS Committee on Open Government (COOG) for an advisory opinion, and a financial-audit referral to the NYS Authorities Budget Office and the Office of the State Comptroller.</li></ul><br/><h3 class='text-base font-bold text-white mt-4 mb-1'>The Documents Are Public.</h3>Every document NYSTA produced is now hosted at <a href='/foil/' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>the FOIL documents</a> and catalogued by FOIL category at <a href='/the-facts/foil-evidence' style='color: #c084fc; text-decoration: underline; text-underline-offset: 3px'>the FOIL evidence catalog</a>. Read them. Cite them. They are the public record.<br/><br/><span class='text-danger-400 font-bold' style='text-shadow: 0 0 8px rgba(239,68,68,0.4)'>Forty-nine days bought us 93 records and a stack of admissions: no Alternative Site Analysis, an unilaterally revocable permit, R-O residential-office zoning bypassed by state-land preemption, a Texas-designed monopole built to a code New York doesn&rsquo;t adopt, a 30 kW diesel generator the public never heard about, an internal site name pointing at a school district, and PDF metadata proving they had the documents ready ten days before they handed them over. The story NYSTA tried not to tell is now in writing.</span>",
    },
    {
      date: "May 8, 2026",
...
const corrections = [
  {
    date: "May 8, 2026",
    title: "FOIL R000082 Production — Site-Wide Updates from 93 Documents",
    changes: [
      {
      ...
      {
        what: "Surrounding parcel zoning disclosed",
        before: "Surrounding zoning not specifically stated.",
        after:
          "Surrounding parcel zoning is R-O (Residence-Office) per AT&T's construction drawings Rev 2 (11/7/2025), Sheet T01.",
        pages: ["Homepage", "Loophole Kings", "Community"],
      },
      {
        what: "Tower designer identified",
        before: "Tower designer not specified.",
        after:
        ...
        pages: ["Highway Safety", "Loophole Kings"],
      },
      {
        what: "Crane operator identified",
        before: "Crane contractor unknown.",
        after:
          "Clark Rigging & Rental (Mike Dombroski, 945 Spencer Street, Syracuse NY 13204) per FAA Aeronautical Study 2025-AEA-11322-OE.",
        pages: ["Aviation", "Highway Safety"],
      },
      {
        what: "AT&T site name and equipment manifest disclosed",
        before: "AT&T equipment configuration unknown.",
        after:
        ...
        pages: ["Health", "Loophole Kings"],
      },
      {
        what: "Emergency services framing nuanced",
        before:
        ...
        pages: ["Loophole Kings", "Take Action"],
      },
      {
        what: "FOIL release timing documented as deliberate withholding",
        before: "FOIL release on May 8, 2026 framed as completion of NYSTA review.",
        after:
        ...
        pages: ["Changelog", "Loophole Kings"],
      },
    ],
  },
  {
