...
const corrections = [
  {
    ...
    changes: [
      ...
      },
      {
        ...
        after:
          "PDF metadata reveals the redacted PTI Permit was finalized by NYSTA on April 28, 2026 — 10 days before release — supporting a POL §89(4)(c) finding that the Authority had no reasonable basis for the period of denial.",
