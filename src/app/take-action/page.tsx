                  ...
                  <div className="max-h-[320px] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="space-y-4 mb-3">
                      ...
                      <p className="text-xs text-dark-300 leading-relaxed">
                        ...
                        <strong className="text-dark-200">(e)</strong>{" "}the surrounding parcel is zoned <strong className="text-danger-400">R-O (Residence-Office)</strong>{" "}per AT&amp;T&rsquo;s own construction drawings (Rev 2, November 7, 2025), and the state-land preemption was used to bypass the residential-office zoning that would otherwise have prevented this commercial telecommunications structure under any local approval process;{" "}
                        <strong className="text-dark-200">(f)</strong>{" "}the tower has been designed by Sabre Industries to ANSI/TIA-222-H, a structural standard not referenced in Chapter 35 of the 2020 Building Code of New York State (which references the older ANSI/TIA-222-G-2005), and this standards mismatch was flagged in writing by the New York State Thruway Authority&rsquo;s own Code Compliance Specialist and never reconciled in the public record; and{" "}
                        <strong className="text-dark-200">(g)</strong>{" "}PDF metadata of the produced records demonstrates that the New York State Thruway Authority had the redacted version of Occupancy Permit T3U250002 production-ready by <strong className="text-danger-400">April 28, 2026</strong>{" "}&mdash; six days after the agency&rsquo;s own extended response deadline of April 22, 2026 &mdash; but did not release any records to the petitioner until May 8, 2026, evidencing a deliberate ten-day withholding of records the agency had already finalized, which under POL &sect;89(4)(c) supports a finding that the Authority had no reasonable basis for the period of denial;
                      </p>
                    </div>
