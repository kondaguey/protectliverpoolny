    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 pt-16 pb-12 md:pt-24 md:pb-16">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-dark-800 border border-dark-700/50 rounded-full text-dark-300 text-xs font-bold uppercase tracking-wider">
              <FileWarning className="w-3.5 h-3.5" />
              How They're Bypassing Us
            </span>
          </motion.div>
          ...
          >
            ...
            <br />
            They're Finding a Way Around{" "}
            <span className="text-danger-500">Every Single One.</span>
          </motion.h1>
